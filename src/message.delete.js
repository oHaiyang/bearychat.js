...
export default function messageDelete(payload) {
  return new Promise((resolve, reject) => {
    const err = validate('POST', '/message.delete', payload);
    if (err) {
      reject(err);
      return;
    }
    ...
    /* eslint-disable */
    const api = getBasePath('https://api.stage.bearychat.com/v1') + '/message.delete';
    /* eslint-enable */
