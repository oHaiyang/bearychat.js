...
export default function messageQuery(payload) {
  return new Promise((resolve, reject) => {
    const err = validate('POST', '/message.query', payload);
    if (err) {
      reject(err);
      return;
    }
    ...
    /* eslint-disable */
    const api = getBasePath('https://api.stage.bearychat.com/v1') + '/message.query';
    /* eslint-enable */
