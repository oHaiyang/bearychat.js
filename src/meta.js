...
export default function meta(payload) {
  return new Promise((resolve, reject) => {
    const err = validate('GET', '/meta', payload);
    if (err) {
      reject(err);
      return;
    }
    ...
    /* eslint-disable */
    const api = getBasePath('https://api.stage.bearychat.com/v1') + '/meta?' + qs.stringify(payload);
    /* eslint-enable */
