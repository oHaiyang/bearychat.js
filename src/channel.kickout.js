...
export default function channelKickout(payload) {
  return new Promise((resolve, reject) => {
    const err = validate('POST', '/channel.kickout', payload);
    if (err) {
      reject(err);
      return;
    }
    ...
    /* eslint-disable */
    const api = getBasePath('https://api.stage.bearychat.com/v1') + '/channel.kickout';
    /* eslint-enable */
