...
export default function userUpdateMe(payload) {
  return new Promise((resolve, reject) => {
    const err = validate('PATCH', '/user.update_me', payload);
    if (err) {
      reject(err);
      return;
    }
    ...
    /* eslint-disable */
    const api = getBasePath('https://api.stage.bearychat.com/v1') + '/user.update_me';
    /* eslint-enable */
