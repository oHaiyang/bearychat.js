...
export default function channelInvite(payload) {
  return new Promise((resolve, reject) => {
    const err = validate('POST', '/channel.invite', payload);
    if (err) {
      reject(err);
      return;
    }
    ...
    /* eslint-disable */
    const api = getBasePath('https://api.stage.bearychat.com/v1') + '/channel.invite';
    /* eslint-enable */
