...
export default function userInfo(payload) {
  return new Promise((resolve, reject) => {
    const err = validate('GET', '/user.info', payload);
    if (err) {
      reject(err);
      return;
    }
    ...
    /* eslint-disable */
    const api = getBasePath('https://api.stage.bearychat.com/v1') + '/user.info?' + qs.stringify(payload);
    /* eslint-enable */
